...
int main(int argc, char ** argv) {
    ...
    gpt_params params;
    params.model = "vietcuna-3b-ggml-fp16-q4_0/ggml-model-vietcuna-3b-f16-q4_0.bin";
    params.prompt = "Below is an instruction that describes a task.\nWrite a response that appropriately completes the request.\n\n### Instruction:Giới thiệu về công ty Apple\n### Response:";
